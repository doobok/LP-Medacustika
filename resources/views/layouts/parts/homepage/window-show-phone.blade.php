<div id="contacts" class="uk-modal-full" uk-modal>
    <div class="uk-modal-dialog">
        <button class="uk-modal-close-full uk-close-large" type="button" uk-close></button>
        <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
            <div class="uk-background-cover" style="background-image: url('images/homepage/contact-tile.jpg ');" uk-height-viewport></div>
            <div class="uk-padding-large">
                <h1 class="uk-heading-small" uk-scrollspy="cls: uk-animation-slide-right-medium; delay: 100">Вы сделали правильный выбор!</h1>
